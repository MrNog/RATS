...
## Locked look (the fixed identity — everything else is free to reinvent)

- **Rat:** rugged dark-brown fur, prominent whiskers, a broken notched ear and a heavy jaw, cold eyes lit
  hard **bronze-amber**, clawed gauntlets. **Thick-necked, broad, heavy with muscle** — a slab of a rat.
  The most physically imposing raider in the set. Never fat — dense, athletic power.
- **Class read:** **Arms Warrior** — no magic at all. **Pure steel and weight.** His power is the swing.
- **Armor:** massive weather-beaten bronze-and-iron plate — deep-gouged pauldrons, a dented breastplate,
  chain-and-leather at the joints, a heavy war-tabard worn to strips, and **no helm** (bare-headed, so
  the face reads). Everything scuffed and dull, nothing shiny.
- **Weapon:** ONE **enormous two-handed greatsword** — a slab of notched, chipped steel taller than
  he is — gripped in **BOTH hands**. NO shield, NO second weapon, ever.
- **Signature detail:** the **grounded stance** — the greatsword driven POINT-DOWN into the ground in front
  of him, both clawed hands stacked on the pommel at chest height, head up and clear ABOVE the hands.
  Raw, grounded, no glow, no magic. **NEVER pose the sword above or behind his head** — see AI-pose rule below.

## Palette & key light

- **Palette:** dark bronze plate, gouged iron, rust brown, worn crimson tabard, cold steel.
  Class colour Warrior `#C69B6D` (the strip tints to that warm bronze — perfect match).
- **Key light:** a **hard low fire-orange light from the front-left** (burning wreckage off-frame) raking
  across the plate and the steel; deep shadow behind. **NO magical glow** — he is lit by the world, not by power.

## Per-format pose + ambient (SUGGESTIONS, not locks — vary every time)

- **Character card (21:9):** greatsword grounded point-down, both hands on the pommel, chest heaving.
- **Profile banner (4:1, no text):** **the grounded stance** — LOW camera, the greatsword driven POINT-DOWN
  into the ground in front of him, both clawed hands stacked on the pommel at CHEST height, arms down and
  well clear of his head, shoulders squared, jaw set, boots planted wide. He sits RIGHT and fills it.
  Dark left third. (The only banner in the set with **no magical light at all**.)
- **Discord icon (1:1, face crop):** broken ear, heavy weathered jaw, bronze-amber eyes, gouged pauldron.
- **iPhone wallpaper (9:19.5):** planted lower-center in a smoking breach, sword grounded, smoke above.
- **Combat / lore moment:** an unstoppable advance, sword carried low at his side, blade trailing.

## ⚠️ AI-pose rule (learned the hard way)

**Never put the weapon above, behind or across his head.** Every overhead / wind-up / raised-blade generation
came back broken: the head fused into the shoulder, the arms bent the wrong way, the hands mangled, the sword
floating unattached. Image models cannot resolve two hands *and* a face when both are stacked behind the skull.

Keep it safe: **hands at chest height or lower, always in clear frame, always separated from the head by
...
- **The only pure-physical, no-magic banner in the set** (with the hunters). That is deliberately his
  identity: while every other rat glows, **Shmurda is just steel.** Do not add a magical glow to his sword.

---

## Profile-banner (BG) prompt — 4:1, NO text

Save as `images/profile-bg/shmurda/shmurda.png`.

```
Digital fantasy illustration, cinematic 4:1 ultra-wide profile banner / hero strip (2400x600), World of Warcraft cinematic concept art, dark heroic-fantasy Horde style, painterly brushwork, ultra-detailed, subtle film-grain texture overlay. Heavy, grounded, physical — raw steel and weight, NO magic. NO text, NO title, NO name, NO watermark, NO logo, NO insignia — pure illustration only, all text added later by the page.

Subject: Shmurda, an anthropomorphic Arms Warrior rat — the guild's frontline champion. Rugged dark-brown fur, prominent whiskers, a broken notched ear, a heavy weathered jaw, cold eyes lit hard BRONZE-AMBER, clawed gauntlets; THICK-NECKED, BROAD and HEAVY WITH DENSE MUSCLE — the most physically imposing rat in the guild, powerful and athletic but NEVER fat or chubby. Grim, stoic, veteran, NOT cute or soft. A muscular rat with EXACTLY ONE tail, one head, two arms, two legs, well-formed hands. BARE-HEADED, no helm, so his face reads clearly. Armor: massive weather-beaten bronze-and-iron plate — deep-gouged pauldrons, a dented breastplate, chain-and-leather at the joints, a heavy war-tabard worn down to strips. Everything scuffed and dull; nothing shiny or ornate.

Weapon: ONE ENORMOUS two-handed GREATSWORD — a slab of notched, chipped, unpolished steel, taller than he is — its POINT DRIVEN DOWN INTO THE GROUND in front of him, both clawed hands stacked on the pommel. NO shield, NO second weapon, NO extra weapons — ONLY the one greatsword. The blade is clean of any magical glow — it is plain, weathered steel.

Pose & composition (wide profile-banner backdrop): THE GROUNDED STANCE — LOW CAMERA looking UP at him. The greatsword stands POINT-DOWN in the earth in FRONT of his body, the blade rising vertically between him and the viewer; BOTH clawed hands rest stacked on the pommel at CHEST HEIGHT, ARMS DOWN and RELAXED. CRITICAL: his HANDS stay LOW and FULLY VISIBLE in front of his chest, and his HEAD is UP and COMPLETELY CLEAR ABOVE them — nothing crosses, covers or passes behind his head; there is OPEN SPACE between his hands and his face. Shoulders squared, chin up, boots planted wide, weight settled — immovable, unhurried, a wall of a rat. He FILLS the RIGHT portion of the ultra-wide strip, turned to face LEFT into the frame. Keep the LEFT ~third DARK and low-detail negative space (page text overlays there). Correct proportions, face clear and readable, neck natural and thick, shoulders and elbows bending only the way they can, the stance balanced, weighted and physically plausible.

Setting: a dark, desaturated ruined fortress wall — shattered stone, a collapsed gate and smouldering timber silhouetted far behind, kept shadowy and low-detail so it never competes; pure backdrop, no figures.

Color palette & lighting: dark bronze plate, gouged iron, rust brown, worn crimson tabard, cold steel, deep shadow. A HARD LOW FIRE-ORANGE LIGHT rakes in from the FRONT-LEFT (smouldering wreckage off-frame), scraping across his plate, his weathered face and the raised steel and tinting the whole strip warm bronze; deep shadow behind him; left third fades to dark. High contrast. IMPORTANT: he is lit ENTIRELY by the world — there is NO magical glow anywhere on him or his sword.
